...
[void]$homePage.AppendLine('        <div class="home-actions"><a href="library/">Full Library</a><a href="about/">About / License</a><a href="data/public-lexical/manifest.json">Lexical Export Manifest</a></div>')
...
[void]$aboutPage.AppendLine('          <p class="export-actions"><a class="export-button" href="../data/public-lexical/manifest.json">Manifest</a><a class="export-button" href="../data/public-lexical/sitewide/claim-index.jsonl">Compact claim index</a><a class="export-button" href="../data/public-lexical/sitewide/normalized-lookup.json">Normalized lookup</a><a class="export-button" href="../prompts/use-lexical-workbench.md">AI workflow prompt</a></p>')
[void]$aboutPage.AppendLine('        </section>')
[void]$aboutPage.AppendLine('        <section class="home-section">')
