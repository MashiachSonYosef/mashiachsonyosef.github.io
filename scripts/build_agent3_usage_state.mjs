...
const oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch = readJson(
  options.oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch,
);
const oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset = readJson(
  options.oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset,
);
const oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch = readJson(
  options.oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch,
);
const oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch = readJson(
  options.oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch,
);
const oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract = readJson(
  options.oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract,
);
...
if (
  oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.artifact_type !==
  'agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_crossmatch'
) {
  throw new Error(
    `${options.oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch} is not an Agent 3 old-dictionary candidate-use bridge-gap direct source-RID locator crossmatch`,
  );
}
if (
  oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.artifact_type !==
  'agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_workset'
) {
  throw new Error(
    `${options.oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset} is not an Agent 3 old-dictionary candidate-use bridge-gap direct source-RID anomaly workset`,
  );
}
if (
  oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.artifact_type !==
  'agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_crossmatch'
) {
  throw new Error(
    `${options.oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch} is not an Agent 3 old-dictionary candidate-use bridge-gap direct source-RID owner/action crossmatch`,
  );
}
if (
  oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.artifact_type !==
  'agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_crossmatch'
) {
  throw new Error(
    `${options.oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch} is not an Agent 3 old-dictionary candidate-use bridge-gap direct source-RID downstream gap crossmatch`,
  );
}
if (
  oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.artifact_type !==
  'agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract'
) {
  throw new Error(
    `${options.oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract} is not an Agent 3 old-dictionary candidate-use bridge-gap direct source-RID row-level return contract`,
  );
}
...
const validators = unique([
  ...
  'scripts/validate_agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_crossmatch.mjs',
  'scripts/validate_agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_workset.mjs',
  'scripts/validate_agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_crossmatch.mjs',
  'scripts/validate_agent3_old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_crossmatch.mjs',
...
const artifact = {
  ...
  current_metrics: {
    ...
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_rows: Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.workset_rows || 0),
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_occ_source_rids: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.workset_occurrences || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.unique_source_rids || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_paths: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent2_contract_rows_matched || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent1_public_domain_exact_rows_matched || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent1_public_domain_all_queue_locator_hits || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent1_commercial_exact_rows_matched || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent1_commercial_all_queue_locator_hits || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent1_commercial_ref_gap_rows_matched || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_blockers: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent2_source_citation_or_url_present_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.agent2_transform_rule_still_blocked_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.zero_ref_count_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.process_timeout_records || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_route_law: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.a07_approval_route_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.a06_evidence_owner_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.a06_approval_requested_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_claims: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.source_license_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.source_provenance_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.source_citation_supplied_by_agent3_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.source_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.definition_authority_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.accepted_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.publication_or_release_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidLocatorCrossmatch.counts?.forbidden_payload_field_hits || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_rows: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.input_locator_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.selected_anomaly_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.non_anomaly_reviewed_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_occ_source_rids: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.selected_anomaly_occurrences || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.reviewed_occurrences || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.unique_anomaly_source_rids || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.unique_reviewed_source_rids || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_flags: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.duplicate_public_domain_locator_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.duplicate_commercial_locator_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.zero_public_domain_refs_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.zero_commercial_refs_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.commercial_ref_gap_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.multi_public_domain_rid_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.multi_commercial_rid_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_blockers: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.agent2_source_citation_or_url_present_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.agent2_transform_rule_still_blocked_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.inherited_process_timeout_records || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.new_broad_search_commands_run || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_route_law: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.a07_approval_route_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.a06_evidence_owner_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.a06_approval_requested_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_claims: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.source_license_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.source_provenance_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.source_citation_supplied_by_agent3_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.source_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.definition_authority_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.answer_selection_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.accepted_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.publication_or_release_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidAnomalyWorkset.counts?.forbidden_payload_field_hits || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_rows: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.input_reviewed_locator_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.input_selected_anomaly_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.owner_action_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_occ_source_rids: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.owner_action_occurrences || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.unique_source_rids || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_kinds: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.duplicate_locator_action_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.zero_ref_ref_gap_action_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.multi_rid_scope_action_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_owners: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.agent10_package_intake_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.agent1_required_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.agent2_required_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.a07_required_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.a06_evidence_only_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.required_downstream_field_cells || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_blockers: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.source_citation_or_url_present_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.transform_rule_still_blocked_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.inherited_process_timeout_records || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.new_broad_search_commands_run || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_route_law: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.a07_approval_route_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.a06_evidence_owner_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.a06_approval_requested_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_claims: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.source_license_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.source_provenance_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.source_citation_supplied_by_agent3_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.source_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.definition_authority_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.answer_selection_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.route_publication_support_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.accepted_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.release_actions || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.publication_or_release_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidOwnerActionCrossmatch.counts?.forbidden_payload_field_hits || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_rows: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.owner_action_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.row_level_downstream_gap_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.owner_action_occurrences || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.unique_source_rids || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_matches: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.downstream_coverage_rows_matched || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent2_direct_contract_matched_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent2_direct_contract_validation_passed_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent10_broad_context_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent10_preboundary_broad_context_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_consumption: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent10_source_citation_row_level_consumed_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent10_preboundary_row_level_consumed_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent10_current_refresh_row_level_hit_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.agent1_downstream_alignment_row_level_hit_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_blockers: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.source_citation_or_url_present_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.transform_rule_still_blocked_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.required_downstream_return_field_cells || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_route_law: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.a07_approval_route_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.a06_evidence_owner_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.a06_approval_requested_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_claims: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.source_license_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.source_provenance_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.source_citation_supplied_by_agent3_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.source_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.definition_authority_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.answer_selection_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.route_publication_support_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.accepted_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.release_actions || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.publication_or_release_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidDownstreamGapCrossmatch.counts?.forbidden_payload_field_hits || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_rows: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.input_downstream_gap_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.contract_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.contract_occurrences || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.unique_source_rids || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_owners: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.agent10_return_contract_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.agent1_agent2_return_contract_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.queue_scope_dedupe_contract_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.ref_gap_contract_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.exact_rid_scope_contract_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_fields: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.agent10_return_field_cells || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.agent1_agent2_return_field_cells || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.action_specific_return_field_cells || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_blockers: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.row_level_downstream_gap_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.agent10_broad_context_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.agent10_row_level_consumed_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.source_citation_or_url_present_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.transform_rule_still_blocked_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_route_law: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.a07_approval_route_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.a06_evidence_owner_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.a06_approval_requested_rows || 0)}`,
    old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_claims: `${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.source_license_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.source_provenance_acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.source_citation_supplied_by_agent3_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.source_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.definition_authority_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.answer_selection_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.route_publication_support_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.accepted_text_rows || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.release_actions || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.publication_or_release_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.acceptance_claims || 0)}-${Number(oldDictionaryCandidateUseBridgeGapDirectSourceRidRowLevelReturnContract.counts?.forbidden_payload_field_hits || 0)}`,
...
function writeReport(relativePath, artifact) {
  const lines = [
    ...
    `- Old-dictionary candidate-use bridge-gap direct source-RID locator rows / occ-sourceRIDs / A2-PDexact-PDall-commercialexact-commercialall-refgap / citationpresent-transformblocked-zeroref-timeouts / A07-A06-A06approval / license-provenance-citationsupplied-sourcetext-definition-acceptedtext-release-acceptance-forbidden claims: ${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_rows}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_occ_source_rids}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_paths}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_blockers}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_route_law}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_locator_claims}`,
    `- Old-dictionary candidate-use bridge-gap direct source-RID anomaly reviewed-selected-nonanomaly / selectedocc-reviewedocc-anomalyRIDs-reviewedRIDs / duplicatePD-duplicateCommercial-zeroPD-zeroCommercial-refgap-multiPD-multiCommercial / citationpresent-transformblocked-inheritedTimeouts-newBroadSearch / A07-A06-A06approval / license-provenance-citationsupplied-sourcetext-definition-answer-acceptedtext-release-acceptance-forbidden claims: ${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_rows}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_occ_source_rids}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_flags}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_blockers}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_route_law}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_anomaly_claims}`,
    `- Old-dictionary candidate-use bridge-gap direct source-RID owner/action reviewed-selected-action / occ-sourceRIDs / dedupe-refgap-exactscope / Agent10-Agent1-Agent2-A07-A06-fields / citationpresent-transformblocked-inheritedTimeouts-newBroadSearch / A07-A06-A06approval / license-provenance-citationsupplied-sourcetext-definition-answer-routepub-acceptedtext-releaseactions-releaseclaims-acceptance-forbidden claims: ${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_rows}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_occ_source_rids}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_kinds}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_owners}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_blockers}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_route_law}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_owner_action_claims}`,
    `- Old-dictionary candidate-use bridge-gap direct source-RID downstream gap action-gaps-occ-sourceRIDs / coverage-Agent2-valid-A10broad-A10preboundary / A10source-A10preboundary-A10refresh-Agent1alignment rowlevel / citationpresent-transformblocked-fields / A07-A06-A06approval / license-provenance-citationsupplied-sourcetext-definition-answer-routepub-acceptedtext-releaseactions-releaseclaims-acceptance-forbidden claims: ${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_rows}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_matches}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_consumption}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_blockers}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_route_law}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_downstream_gap_claims}`,
    `- Old-dictionary candidate-use bridge-gap direct source-RID row-level return contract input-contract-occ-sourceRIDs / Agent10-Agent1_2-dedupe-refgap-exactscope / Agent10fields-Agent1_2fields-actionfields / gaps-A10broad-A10rowlevel-citationpresent-transformblocked / A07-A06-A06approval / license-provenance-citationsupplied-sourcetext-definition-answer-routepub-acceptedtext-releaseactions-releaseclaims-acceptance-forbidden claims: ${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_rows}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_owners}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_fields}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_blockers}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_route_law}/${artifact.current_metrics.old_dictionary_candidate_use_bridge_gap_direct_source_rid_row_level_return_contract_claims}`,
