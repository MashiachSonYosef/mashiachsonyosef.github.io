...
function validateCounts(packageItems) {
  ...
  if (Number(artifact.counts?.selected_occurrence_navigation_rows || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_navigation_rows must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_source_refs || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_occurrence_navigation_source_refs must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_work_anchors || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_occurrence_navigation_work_anchors must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_works || 0) !== Number(artifact.counts?.selected_works || 0)) {
    issues.push('selected_occurrence_navigation_works must equal selected_works');
  }
  ...
  if (Number(artifact.counts?.selected_occurrence_navigation_route_ids || 0) !== Number(artifact.counts?.selected_route_ids || 0)) {
    issues.push('selected_occurrence_navigation_route_ids must equal selected_route_ids');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_buckets || 0)) {
    issues.push('selected_occurrence_navigation_provenance_buckets must equal selected_provenance_buckets');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_rows_with_source_link || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_navigation_rows_with_source_link must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_rows_with_work_anchor || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_navigation_rows_with_work_anchor must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_rows_with_hebrew_context || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_navigation_rows_with_hebrew_context must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_rows_with_focus_marker || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_navigation_rows_with_focus_marker must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_navigation_rows_with_provenance || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_navigation_rows_with_provenance must equal selected_rows');
  }
  ...
  if (Number(artifact.counts?.selected_occurrence_navigation_collision_memberships || 0) !== Number(artifact.counts?.selected_collision_occurrence_rows || 0)) {
    issues.push('selected_occurrence_navigation_collision_memberships must equal selected_collision_occurrence_rows');
  }
  ...
  if (Number(artifact.counts?.selected_navigation_edge_source_occurrences || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_navigation_edge_source_occurrences must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_navigation_edge_target_occurrences || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_navigation_edge_target_occurrences must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_navigation_edge_source_refs || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_navigation_edge_source_refs must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_navigation_edge_works || 0) !== Number(artifact.counts?.selected_works || 0)) {
    issues.push('selected_navigation_edge_works must equal selected_works');
  }
  ...
  if (Number(artifact.counts?.selected_navigation_edge_route_ids || 0) !== Number(artifact.counts?.selected_route_ids || 0)) {
    issues.push('selected_navigation_edge_route_ids must equal selected_route_ids');
  }
  if (Number(artifact.counts?.selected_navigation_edge_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_buckets || 0)) {
    issues.push('selected_navigation_edge_provenance_buckets must equal selected_provenance_buckets');
  }
  if (Number(artifact.counts?.selected_navigation_edge_same_frame_edges || 0) + Number(artifact.counts?.selected_navigation_edge_bridge_edges || 0) !== Number(artifact.counts?.selected_navigation_edge_rows || 0)) {
    issues.push('selected_navigation_edge_same_frame_edges + bridge_edges must equal selected_navigation_edge_rows');
  }
  ...
  if (Number(artifact.counts?.selected_frame_bridge_route_ids || 0) !== Number(artifact.counts?.selected_route_ids || 0)) {
    issues.push('selected_frame_bridge_route_ids must equal selected_route_ids');
  }
  ...
  if (Number(artifact.counts?.selected_occurrence_adjacency_rows || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_adjacency_rows must equal selected_rows');
  }
  ...
  if (Number(artifact.counts?.selected_occurrence_adjacency_source_refs || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_occurrence_adjacency_source_refs must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_occurrence_adjacency_works || 0) !== Number(artifact.counts?.selected_works || 0)) {
    issues.push('selected_occurrence_adjacency_works must equal selected_works');
  }
  ...
  if (Number(artifact.counts?.selected_occurrence_adjacency_route_ids || 0) !== Number(artifact.counts?.selected_route_ids || 0)) {
    issues.push('selected_occurrence_adjacency_route_ids must equal selected_route_ids');
  }
  if (Number(artifact.counts?.selected_occurrence_adjacency_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_buckets || 0)) {
    issues.push('selected_occurrence_adjacency_provenance_buckets must equal selected_provenance_buckets');
  }
  ...
  if (Number(artifact.counts?.selected_occurrence_adjacency_strong_links || 0) + Number(artifact.counts?.selected_occurrence_adjacency_moderate_links || 0) + Number(artifact.counts?.selected_occurrence_adjacency_weak_links || 0) !== Number(artifact.counts?.selected_occurrence_adjacency_target_links || 0)) {
    issues.push('selected_occurrence_adjacency strong/moderate/weak counts must equal target links');
  }
  if (Number(artifact.counts?.selected_occurrence_adjacency_rows_with_source_context || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_adjacency_rows_with_source_context must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_adjacency_rows_with_source_link || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_adjacency_rows_with_source_link must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_adjacency_rows_with_source_provenance || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_adjacency_rows_with_source_provenance must equal selected_rows');
  }
  if (Number(artifact.counts?.selected_occurrence_adjacency_rows_with_complete_targets || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_occurrence_adjacency_rows_with_complete_targets must equal selected_rows');
  }
  ...
  if (Number(artifact.counts?.selected_source_hub_occurrence_rows || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_source_hub_occurrence_rows must equal selected_rows');
  }
  ...
  if (Number(artifact.counts?.selected_source_hub_same_frame_links || 0) + Number(artifact.counts?.selected_source_hub_bridge_frame_links || 0) !== Number(artifact.counts?.selected_source_hub_target_links || 0)) {
    issues.push('selected_source_hub_same_frame_links + bridge_frame_links must equal target links');
  }
  if (Number(artifact.counts?.selected_source_hub_strong_links || 0) + Number(artifact.counts?.selected_source_hub_moderate_links || 0) + Number(artifact.counts?.selected_source_hub_weak_links || 0) !== Number(artifact.counts?.selected_source_hub_target_links || 0)) {
    issues.push('selected_source_hub strong/moderate/weak counts must equal target links');
  }
  if (Number(artifact.counts?.selected_source_hub_rows || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_source_hub_rows must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_source_hub_source_refs || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_source_hub_source_refs must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_source_hub_work_anchors || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_source_hub_work_anchors must equal selected_source_refs');
  }
  if (Number(artifact.counts?.selected_source_hub_works || 0) !== Number(artifact.counts?.selected_works || 0)) {
    issues.push('selected_source_hub_works must equal selected_works');
  }
  ...
  if (Number(artifact.counts?.selected_source_hub_route_ids || 0) !== Number(artifact.counts?.selected_route_ids || 0)) {
    issues.push('selected_source_hub_route_ids must equal selected_route_ids');
  }
  if (Number(artifact.counts?.selected_source_hub_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_buckets || 0)) {
    issues.push('selected_source_hub_provenance_buckets must equal selected_provenance_buckets');
  }
  ...
  if (Number(artifact.counts?.selected_source_hub_target_samples_with_links || 0) !== Number(artifact.counts?.selected_source_hub_target_samples || 0)) {
    issues.push('selected_source_hub_target_samples_with_links must equal selected_source_hub_target_samples');
  }
  if (Number(artifact.counts?.selected_source_hub_target_samples_with_context || 0) !== Number(artifact.counts?.selected_source_hub_target_samples || 0)) {
    issues.push('selected_source_hub_target_samples_with_context must equal selected_source_hub_target_samples');
  }
  if (Number(artifact.counts?.selected_work_hub_occurrence_rows || 0) !== Number(artifact.counts?.selected_rows || 0)) {
    issues.push('selected_work_hub_occurrence_rows must equal selected_rows');
  }
  ...
  if (Number(artifact.counts?.selected_work_hub_same_frame_links || 0) + Number(artifact.counts?.selected_work_hub_bridge_frame_links || 0) !== Number(artifact.counts?.selected_work_hub_target_links || 0)) {
    issues.push('selected_work_hub_same_frame_links + bridge_frame_links must equal target links');
  }
  if (Number(artifact.counts?.selected_work_hub_strong_links || 0) + Number(artifact.counts?.selected_work_hub_moderate_links || 0) + Number(artifact.counts?.selected_work_hub_weak_links || 0) !== Number(artifact.counts?.selected_work_hub_target_links || 0)) {
    issues.push('selected_work_hub strong/moderate/weak counts must equal target links');
  }
  if (Number(artifact.counts?.selected_work_hub_rows || 0) !== Number(artifact.counts?.selected_works || 0)) {
    issues.push('selected_work_hub_rows must equal selected_works');
  }
  if (Number(artifact.counts?.selected_work_hub_source_refs || 0) !== Number(artifact.counts?.selected_source_refs || 0)) {
    issues.push('selected_work_hub_source_refs must equal selected_source_refs');
  }
  ...
  if (Number(artifact.counts?.selected_work_hub_route_ids || 0) !== Number(artifact.counts?.selected_route_ids || 0)) {
    issues.push('selected_work_hub_route_ids must equal selected_route_ids');
  }
  if (Number(artifact.counts?.selected_work_hub_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_buckets || 0)) {
    issues.push('selected_work_hub_provenance_buckets must equal selected_provenance_buckets');
  }
