...
function validateCounts() {
  for (const field of [
    ...
    'selected_source_hub_occurrence_rows',
    'selected_source_hub_target_links',
    'selected_source_hub_source_refs',
    'selected_source_hub_works',
    'selected_source_hub_frames',
    'selected_source_hub_route_ids',
    'selected_source_hub_provenance_buckets',
    'selected_source_hub_same_frame_links',
    'selected_source_hub_bridge_frame_links',
    'selected_source_hub_rows_with_source_link',
    'selected_source_hub_rows_with_work_anchor',
    'selected_source_hub_rows_with_marked_context',
    'selected_source_hub_rows_with_provenance',
    'selected_source_hub_reader_facing_rows',
    'selected_source_hub_route_payload_field_hits',
    'selected_work_hub_rows',
    'selected_work_hub_occurrence_rows',
    'selected_work_hub_source_refs',
    'selected_work_hub_target_links',
    'selected_work_hub_works',
    'selected_work_hub_frames',
    'selected_work_hub_route_ids',
    'selected_work_hub_provenance_buckets',
    'selected_work_hub_same_frame_links',
    'selected_work_hub_bridge_frame_links',
    'selected_work_hub_rows_with_source_links',
    'selected_work_hub_rows_with_work_anchors',
    'selected_work_hub_rows_with_marked_context',
    'selected_work_hub_rows_with_provenance',
    'selected_work_hub_target_work_samples',
    'selected_work_hub_target_work_samples_with_links',
    'selected_work_hub_target_work_samples_with_context',
    'selected_work_hub_reader_facing_rows',
    'selected_work_hub_route_payload_field_hits',
    'selected_focus_neighbor_rows',
    'selected_focus_neighbor_observations',
    'selected_focus_neighbor_immediate_observations',
    'selected_focus_neighbor_offsets',
    'selected_focus_neighbor_buckets',
    'selected_focus_neighbor_unique_tokens',
    'selected_focus_neighbor_rows_with_focus_marker',
    'selected_focus_neighbor_rows_with_neighbor_window',
    'selected_focus_neighbor_rows_with_source_link',
    'selected_focus_neighbor_rows_with_work_anchor',
    'selected_focus_neighbor_rows_with_marked_context',
    'selected_focus_neighbor_rows_with_provenance',
    'selected_focus_neighbor_route_ids',
    'selected_focus_neighbor_provenance_buckets',
    'selected_focus_neighbor_reader_facing_rows',
    'selected_focus_neighbor_route_payload_field_hits',
    'selected_frame_neighbor_frame_rows',
    'selected_frame_neighbor_cells',
    'selected_frame_neighbor_observations',
    'selected_frame_neighbor_immediate_observations',
    'selected_frame_neighbor_shared_buckets',
    'selected_frame_neighbor_specific_buckets',
    'selected_frame_neighbor_route_ids',
    'selected_frame_neighbor_provenance_buckets',
    'selected_frame_neighbor_reader_facing_rows',
    'selected_frame_neighbor_route_payload_field_hits',
  ...
  if (Number(artifact.counts?.selected_source_hub_occurrence_rows || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_source_hub_occurrence_rows must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_source_hub_target_links || 0) !== Number(artifact.counts?.selected_occurrence_adjacency_target_links || 0)) {
    issues.push('selected_source_hub_target_links must equal selected_occurrence_adjacency_target_links');
  }
  if (Number(artifact.counts?.selected_source_hub_source_refs || 0) !== Number(artifact.counts?.selected_source_diversity_unique_source_refs || 0)) {
    issues.push('selected_source_hub_source_refs must equal selected_source_diversity_unique_source_refs');
  }
  if (Number(artifact.counts?.selected_source_hub_rows || 0) !== Number(artifact.counts?.selected_source_diversity_unique_source_refs || 0)) {
    issues.push('selected_source_hub_rows must equal selected_source_diversity_unique_source_refs');
  }
  if (Number(artifact.counts?.selected_source_hub_works || 0) !== Number(artifact.counts?.selected_source_diversity_unique_works || 0)) {
    issues.push('selected_source_hub_works must equal selected_source_diversity_unique_works');
  }
  if (Number(artifact.counts?.selected_source_hub_frames || 0) !== Number(artifact.counts?.selected_frame_summary_frames || 0)) {
    issues.push('selected_source_hub_frames must equal selected_frame_summary_frames');
  }
  if (Number(artifact.counts?.selected_source_hub_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_source_hub_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.counts?.selected_source_hub_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_source_hub_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.counts?.selected_source_hub_same_frame_links || 0) + Number(artifact.counts?.selected_source_hub_bridge_frame_links || 0) !== Number(artifact.counts?.selected_source_hub_target_links || 0)) {
    issues.push('selected_source_hub same/bridge links must equal target links');
  }
  if (Number(artifact.counts?.selected_source_hub_rows_with_source_link || 0) !== Number(artifact.counts?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_source_link must equal selected_source_hub_rows');
  }
  if (Number(artifact.counts?.selected_source_hub_rows_with_work_anchor || 0) !== Number(artifact.counts?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_work_anchor must equal selected_source_hub_rows');
  }
  if (Number(artifact.counts?.selected_source_hub_rows_with_marked_context || 0) !== Number(artifact.counts?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_marked_context must equal selected_source_hub_rows');
  }
  if (Number(artifact.counts?.selected_source_hub_rows_with_provenance || 0) !== Number(artifact.counts?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_provenance must equal selected_source_hub_rows');
  }
  if (Number(artifact.counts?.selected_source_hub_reader_facing_rows || 0) !== 0) {
    issues.push('selected_source_hub_reader_facing_rows must be 0');
  }
  if (Number(artifact.counts?.selected_source_hub_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_source_hub_route_payload_field_hits must be 0');
  }
  if (Number(artifact.counts?.selected_work_hub_occurrence_rows || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_work_hub_occurrence_rows must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_work_hub_target_links || 0) !== Number(artifact.counts?.selected_occurrence_adjacency_target_links || 0)) {
    issues.push('selected_work_hub_target_links must equal selected_occurrence_adjacency_target_links');
  }
  if (Number(artifact.counts?.selected_work_hub_source_refs || 0) !== Number(artifact.counts?.selected_source_diversity_unique_source_refs || 0)) {
    issues.push('selected_work_hub_source_refs must equal selected_source_diversity_unique_source_refs');
  }
  if (Number(artifact.counts?.selected_work_hub_rows || 0) !== Number(artifact.counts?.selected_source_diversity_unique_works || 0)) {
    issues.push('selected_work_hub_rows must equal selected_source_diversity_unique_works');
  }
  if (Number(artifact.counts?.selected_work_hub_works || 0) !== Number(artifact.counts?.selected_source_diversity_unique_works || 0)) {
    issues.push('selected_work_hub_works must equal selected_source_diversity_unique_works');
  }
  if (Number(artifact.counts?.selected_work_hub_frames || 0) !== Number(artifact.counts?.selected_frame_summary_frames || 0)) {
    issues.push('selected_work_hub_frames must equal selected_frame_summary_frames');
  }
  if (Number(artifact.counts?.selected_work_hub_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_work_hub_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.counts?.selected_work_hub_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_work_hub_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.counts?.selected_work_hub_same_frame_links || 0) + Number(artifact.counts?.selected_work_hub_bridge_frame_links || 0) !== Number(artifact.counts?.selected_work_hub_target_links || 0)) {
    issues.push('selected_work_hub same/bridge links must equal target links');
  }
  if (Number(artifact.counts?.selected_work_hub_rows_with_source_links || 0) !== Number(artifact.counts?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_source_links must equal selected_work_hub_rows');
  }
  if (Number(artifact.counts?.selected_work_hub_rows_with_work_anchors || 0) !== Number(artifact.counts?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_work_anchors must equal selected_work_hub_rows');
  }
  if (Number(artifact.counts?.selected_work_hub_rows_with_marked_context || 0) !== Number(artifact.counts?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_marked_context must equal selected_work_hub_rows');
  }
  if (Number(artifact.counts?.selected_work_hub_rows_with_provenance || 0) !== Number(artifact.counts?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_provenance must equal selected_work_hub_rows');
  }
  if (Number(artifact.counts?.selected_work_hub_target_work_samples_with_links || 0) !== Number(artifact.counts?.selected_work_hub_target_work_samples || 0)) {
    issues.push('selected_work_hub_target_work_samples_with_links must equal selected_work_hub_target_work_samples');
  }
  ...
  if (Number(artifact.counts?.selected_work_hub_reader_facing_rows || 0) !== 0) {
    issues.push('selected_work_hub_reader_facing_rows must be 0');
  }
  if (Number(artifact.counts?.selected_work_hub_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_work_hub_route_payload_field_hits must be 0');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows_with_focus_marker || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_focus_marker must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows_with_neighbor_window || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_neighbor_window must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows_with_source_link || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_source_link must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows_with_work_anchor || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_work_anchor must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows_with_marked_context || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_marked_context must equal selected_occurrence_rows');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_rows_with_provenance || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_provenance must equal selected_occurrence_rows');
  }
  ...
  if (Number(artifact.counts?.selected_focus_neighbor_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_focus_neighbor_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_focus_neighbor_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_reader_facing_rows || 0) !== 0) {
    issues.push('selected_focus_neighbor_reader_facing_rows must be 0');
  }
  if (Number(artifact.counts?.selected_focus_neighbor_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_focus_neighbor_route_payload_field_hits must be 0');
  }
  ...
  if (Number(artifact.counts?.selected_frame_neighbor_cells || 0) <= 0) {
    issues.push('selected_frame_neighbor_cells must be positive');
  }
  if (Number(artifact.counts?.selected_frame_neighbor_observations || 0) !== Number(artifact.counts?.selected_focus_neighbor_observations || 0)) {
    issues.push('selected_frame_neighbor_observations must equal selected_focus_neighbor_observations');
  }
  ...
  if (Number(artifact.counts?.selected_frame_neighbor_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_frame_neighbor_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.counts?.selected_frame_neighbor_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_frame_neighbor_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  ...
  if (Number(artifact.counts?.selected_qa_package_items || 0) !== 25) {
    issues.push('selected_qa_package_items must be 25');
  }
...
function validateArtifacts() {
  ...
  for (const field of [
    ...
    'selected_source_hub_index_report',
    'selected_work_hub_index_report',
    'selected_focus_neighbor_index_report',
    'selected_frame_neighbor_matrix_report',
...
function validateValidation() {
  ...
  if (artifact.validation?.selected_source_hub_index_status !== 'present') {
    issues.push('selected_source_hub_index_status must be present');
  }
  if (Number(artifact.validation?.selected_source_hub_occurrence_rows || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_source_hub_occurrence_rows must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_source_hub_target_links || 0) !== Number(artifact.counts?.selected_occurrence_adjacency_target_links || 0)) {
    issues.push('selected_source_hub_target_links must equal selected_occurrence_adjacency_target_links');
  }
  if (Number(artifact.validation?.selected_source_hub_source_refs || 0) !== Number(artifact.counts?.selected_source_diversity_unique_source_refs || 0)) {
    issues.push('selected_source_hub_source_refs must equal selected_source_diversity_unique_source_refs');
  }
  if (Number(artifact.validation?.selected_source_hub_rows || 0) !== Number(artifact.counts?.selected_source_diversity_unique_source_refs || 0)) {
    issues.push('selected_source_hub_rows must equal selected_source_diversity_unique_source_refs');
  }
  if (Number(artifact.validation?.selected_source_hub_works || 0) !== Number(artifact.counts?.selected_source_diversity_unique_works || 0)) {
    issues.push('selected_source_hub_works must equal selected_source_diversity_unique_works');
  }
  if (Number(artifact.validation?.selected_source_hub_frames || 0) !== Number(artifact.counts?.selected_frame_summary_frames || 0)) {
    issues.push('selected_source_hub_frames must equal selected_frame_summary_frames');
  }
  if (Number(artifact.validation?.selected_source_hub_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_source_hub_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.validation?.selected_source_hub_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_source_hub_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.validation?.selected_source_hub_same_frame_links || 0) + Number(artifact.validation?.selected_source_hub_bridge_frame_links || 0) !== Number(artifact.validation?.selected_source_hub_target_links || 0)) {
    issues.push('selected_source_hub same/bridge links must equal target links');
  }
  if (Number(artifact.validation?.selected_source_hub_rows_with_source_link || 0) !== Number(artifact.validation?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_source_link must equal selected_source_hub_rows');
  }
  if (Number(artifact.validation?.selected_source_hub_rows_with_work_anchor || 0) !== Number(artifact.validation?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_work_anchor must equal selected_source_hub_rows');
  }
  if (Number(artifact.validation?.selected_source_hub_rows_with_marked_context || 0) !== Number(artifact.validation?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_marked_context must equal selected_source_hub_rows');
  }
  if (Number(artifact.validation?.selected_source_hub_rows_with_provenance || 0) !== Number(artifact.validation?.selected_source_hub_rows || 0)) {
    issues.push('selected_source_hub_rows_with_provenance must equal selected_source_hub_rows');
  }
  if (Number(artifact.validation?.selected_source_hub_reader_facing_rows || 0) !== 0) {
    issues.push('selected_source_hub_reader_facing_rows must be 0');
  }
  if (Number(artifact.validation?.selected_source_hub_failed_checks || 0) !== 0) {
    issues.push('selected_source_hub_failed_checks must be 0');
  }
  if (Number(artifact.validation?.selected_source_hub_warning_count || 0) !== 0) {
    issues.push('selected_source_hub_warning_count must be 0');
  }
  if (Number(artifact.validation?.selected_source_hub_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_source_hub_route_payload_field_hits must be 0');
  }
  if (artifact.validation?.selected_work_hub_index_status !== 'present') {
    issues.push('selected_work_hub_index_status must be present');
  }
  if (Number(artifact.validation?.selected_work_hub_occurrence_rows || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_work_hub_occurrence_rows must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_work_hub_target_links || 0) !== Number(artifact.counts?.selected_occurrence_adjacency_target_links || 0)) {
    issues.push('selected_work_hub_target_links must equal selected_occurrence_adjacency_target_links');
  }
  if (Number(artifact.validation?.selected_work_hub_source_refs || 0) !== Number(artifact.counts?.selected_source_diversity_unique_source_refs || 0)) {
    issues.push('selected_work_hub_source_refs must equal selected_source_diversity_unique_source_refs');
  }
  if (Number(artifact.validation?.selected_work_hub_rows || 0) !== Number(artifact.counts?.selected_source_diversity_unique_works || 0)) {
    issues.push('selected_work_hub_rows must equal selected_source_diversity_unique_works');
  }
  if (Number(artifact.validation?.selected_work_hub_works || 0) !== Number(artifact.counts?.selected_source_diversity_unique_works || 0)) {
    issues.push('selected_work_hub_works must equal selected_source_diversity_unique_works');
  }
  if (Number(artifact.validation?.selected_work_hub_frames || 0) !== Number(artifact.counts?.selected_frame_summary_frames || 0)) {
    issues.push('selected_work_hub_frames must equal selected_frame_summary_frames');
  }
  if (Number(artifact.validation?.selected_work_hub_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_work_hub_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.validation?.selected_work_hub_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_work_hub_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.validation?.selected_work_hub_same_frame_links || 0) + Number(artifact.validation?.selected_work_hub_bridge_frame_links || 0) !== Number(artifact.validation?.selected_work_hub_target_links || 0)) {
    issues.push('selected_work_hub same/bridge links must equal target links');
  }
  if (Number(artifact.validation?.selected_work_hub_rows_with_source_links || 0) !== Number(artifact.validation?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_source_links must equal selected_work_hub_rows');
  }
  if (Number(artifact.validation?.selected_work_hub_rows_with_work_anchors || 0) !== Number(artifact.validation?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_work_anchors must equal selected_work_hub_rows');
  }
  if (Number(artifact.validation?.selected_work_hub_rows_with_marked_context || 0) !== Number(artifact.validation?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_marked_context must equal selected_work_hub_rows');
  }
  if (Number(artifact.validation?.selected_work_hub_rows_with_provenance || 0) !== Number(artifact.validation?.selected_work_hub_rows || 0)) {
    issues.push('selected_work_hub_rows_with_provenance must equal selected_work_hub_rows');
  }
  if (Number(artifact.validation?.selected_work_hub_target_work_samples_with_links || 0) !== Number(artifact.validation?.selected_work_hub_target_work_samples || 0)) {
    issues.push('selected_work_hub_target_work_samples_with_links must equal selected_work_hub_target_work_samples');
  }
  if (Number(artifact.validation?.selected_work_hub_target_work_samples_with_context || 0) !== Number(artifact.validation?.selected_work_hub_target_work_samples || 0)) {
    issues.push('selected_work_hub_target_work_samples_with_context must equal selected_work_hub_target_work_samples');
  }
  if (Number(artifact.validation?.selected_work_hub_reader_facing_rows || 0) !== 0) {
    issues.push('selected_work_hub_reader_facing_rows must be 0');
  }
  if (Number(artifact.validation?.selected_work_hub_failed_checks || 0) !== 0) {
    issues.push('selected_work_hub_failed_checks must be 0');
  }
  if (Number(artifact.validation?.selected_work_hub_warning_count || 0) !== 0) {
    issues.push('selected_work_hub_warning_count must be 0');
  }
  if (Number(artifact.validation?.selected_work_hub_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_work_hub_route_payload_field_hits must be 0');
  }
  if (artifact.validation?.selected_focus_neighbor_index_status !== 'present') {
    issues.push('selected_focus_neighbor_index_status must be present');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows_with_focus_marker || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_focus_marker must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows_with_neighbor_window || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_neighbor_window must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows_with_source_link || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_source_link must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows_with_work_anchor || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_work_anchor must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows_with_marked_context || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_marked_context must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_rows_with_provenance || 0) !== Number(artifact.counts?.selected_occurrence_rows || 0)) {
    issues.push('selected_focus_neighbor_rows_with_provenance must equal selected_occurrence_rows');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_observations || 0) <= 0) {
    issues.push('selected_focus_neighbor_observations must be positive');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_immediate_observations || 0) <= 0) {
    issues.push('selected_focus_neighbor_immediate_observations must be positive');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_offsets || 0) <= 0) {
    issues.push('selected_focus_neighbor_offsets must be positive');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_buckets || 0) <= 0) {
    issues.push('selected_focus_neighbor_buckets must be positive');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_unique_tokens || 0) <= 0) {
    issues.push('selected_focus_neighbor_unique_tokens must be positive');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_focus_neighbor_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_focus_neighbor_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_reader_facing_rows || 0) !== 0) {
    issues.push('selected_focus_neighbor_reader_facing_rows must be 0');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_failed_checks || 0) !== 0) {
    issues.push('selected_focus_neighbor_failed_checks must be 0');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_warning_count || 0) !== 0) {
    issues.push('selected_focus_neighbor_warning_count must be 0');
  }
  if (Number(artifact.validation?.selected_focus_neighbor_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_focus_neighbor_route_payload_field_hits must be 0');
  }
  if (artifact.validation?.selected_frame_neighbor_matrix_status !== 'present') {
    issues.push('selected_frame_neighbor_matrix_status must be present');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_frame_rows || 0) !== Number(artifact.counts?.selected_frame_summary_frames || 0)) {
    issues.push('selected_frame_neighbor_frame_rows must equal selected_frame_summary_frames');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_cells || 0) <= 0) {
    issues.push('selected_frame_neighbor_cells must be positive');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_observations || 0) !== Number(artifact.counts?.selected_focus_neighbor_observations || 0)) {
    issues.push('selected_frame_neighbor_observations must equal selected_focus_neighbor_observations');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_immediate_observations || 0) !== Number(artifact.counts?.selected_focus_neighbor_immediate_observations || 0)) {
    issues.push('selected_frame_neighbor_immediate_observations must equal selected_focus_neighbor_immediate_observations');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_shared_buckets || 0) <= 0) {
    issues.push('selected_frame_neighbor_shared_buckets must be positive');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_specific_buckets || 0) <= 0) {
    issues.push('selected_frame_neighbor_specific_buckets must be positive');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_route_ids || 0) !== Number(artifact.counts?.unique_route_ids || 0)) {
    issues.push('selected_frame_neighbor_route_ids must equal unique_route_ids');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_provenance_buckets || 0) !== Number(artifact.counts?.selected_provenance_matrix_buckets || 0)) {
    issues.push('selected_frame_neighbor_provenance_buckets must equal selected_provenance_matrix_buckets');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_reader_facing_rows || 0) !== 0) {
    issues.push('selected_frame_neighbor_reader_facing_rows must be 0');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_failed_checks || 0) !== 0) {
    issues.push('selected_frame_neighbor_failed_checks must be 0');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_warning_count || 0) !== 0) {
    issues.push('selected_frame_neighbor_warning_count must be 0');
  }
  if (Number(artifact.validation?.selected_frame_neighbor_route_payload_field_hits || 0) !== 0) {
    issues.push('selected_frame_neighbor_route_payload_field_hits must be 0');
  }
  ...
  if (Number(artifact.validation?.selected_qa_package_items || 0) !== 25) {
    issues.push('selected_qa_package_items must be 25');
  }
...
function validateCommands() {
  const expectedScripts = {
    ...
    build_selected_source_hub_index: 'build_workbench_usage_selected_source_hub_index.mjs',
    validate_selected_source_hub_index: 'validate_workbench_usage_selected_source_hub_index.mjs',
    build_selected_work_hub_index: 'build_workbench_usage_selected_work_hub_index.mjs',
    validate_selected_work_hub_index: 'validate_workbench_usage_selected_work_hub_index.mjs',
    build_selected_focus_neighbor_index: 'build_workbench_usage_selected_focus_neighbor_index.mjs',
    validate_selected_focus_neighbor_index: 'validate_workbench_usage_selected_focus_neighbor_index.mjs',
    build_selected_frame_neighbor_matrix: 'build_workbench_usage_selected_frame_neighbor_matrix.mjs',
    validate_selected_frame_neighbor_matrix: 'validate_workbench_usage_selected_frame_neighbor_matrix.mjs',
