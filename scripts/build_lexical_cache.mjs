...
const projectAbbreviationDefinitions = [
  ...
  { source_id: 'project-abbreviation:mah-shekatav', surface: 'מ״ש', expansion: 'מה שכתב', renderings: ['what he wrote'] },
  { source_id: 'project-abbreviation:vav-mah-shekatav', surface: 'ומ״ש', expansion: 'ומה שכתב', renderings: ['and what he wrote'], breakdown: [{ hebrew: 'ו־', strict_renderings: ['and'] }, { hebrew: 'מ״ש', strict_renderings: ['what he wrote'] }] },
  { source_id: 'project-abbreviation:ad-kan-leshono', surface: 'עכ״ל', expansion: 'עד כאן לשונו', renderings: ['end of his words', 'thus ends his language'] },
  { source_id: 'project-abbreviation:al-kol-panim', surface: 'עכ״פ', expansion: 'על כל פנים', renderings: ['in any case', 'at any rate'] },
  { source_id: 'project-abbreviation:im-kol-zeh', surface: 'עכ״ז', expansion: 'עם כל זה', renderings: ['nevertheless', 'even so'] },
  { source_id: 'project-abbreviation:siman', surface: 'סי׳', expansion: 'סימן', renderings: ['section', 'sign', 'siman'] },
  { source_id: 'project-abbreviation:seif-katan', surface: 'ס״ק', expansion: 'סעיף קטן', renderings: ['subsection', 'small section'] },
  { source_id: 'project-abbreviation:tosafot', surface: 'תוס׳', expansion: 'תוספות', renderings: ['Tosafot'] },
  { source_id: 'project-abbreviation:ha-tosafot', surface: 'התוס׳', expansion: 'התוספות', renderings: ['the Tosafot'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'תוס׳', strict_renderings: ['Tosafot'] }] },
  ...
  { source_id: 'project-abbreviation:ayin-ayin-sham', surface: 'עיי״ש', expansion: 'עיין שם', renderings: ['see there'] },
  { source_id: 'project-abbreviation:ayin', surface: 'עי׳', expansion: 'עיין', renderings: ['see'] },
  { source_id: 'project-abbreviation:vav-ayin', surface: 'ועי׳', expansion: 'ועיין', renderings: ['and see'], breakdown: [{ hebrew: 'ו־', strict_renderings: ['and'] }, { hebrew: 'עי׳', strict_renderings: ['see'] }] },
  { source_id: 'project-abbreviation:vav-ayin-short', surface: 'וע׳', expansion: 'ועיין', renderings: ['and see'], breakdown: [{ hebrew: 'ו־', strict_renderings: ['and'] }, { hebrew: 'ע׳', strict_renderings: ['see'] }] },
  ...
  { source_id: 'project-abbreviation:rosh', surface: 'רא״ש', expansion: 'רבינו אשר', renderings: ['Rosh'] },
  { source_id: 'project-abbreviation:ha-rosh', surface: 'הרא״ש', expansion: 'רבינו אשר', renderings: ['the Rosh'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'רא״ש', strict_renderings: ['Rosh'] }] },
  { source_id: 'project-abbreviation:ha-ran', surface: 'הר״ן', expansion: 'רבינו ניסים', renderings: ['the Ran'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'ר״ן', strict_renderings: ['Ran'] }] },
  { source_id: 'project-abbreviation:ha-rif', surface: 'הרי״ף', expansion: 'רבי יצחק אלפסי', renderings: ['the Rif'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'רי״ף', strict_renderings: ['Rif'] }] },
  { source_id: 'project-abbreviation:ha-raavad', surface: 'הראב״ד', expansion: 'רבי אברהם בן דוד', renderings: ['the Raavad'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'ראב״ד', strict_renderings: ['Raavad'] }] },
  { source_id: 'project-abbreviation:beit-yosef', surface: 'ב״י', expansion: 'בית יוסף', renderings: ['Beit Yosef'] },
  { source_id: 'project-abbreviation:rambam', surface: 'הרמב״ם', expansion: 'רבי משה בן מימון', renderings: ['Rambam', 'Maimonides'] },
  { source_id: 'project-abbreviation:ha-ramban', surface: 'הרמב״ן', expansion: 'רבי משה בן נחמן', renderings: ['the Ramban', 'Nahmanides'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'רמב״ן', strict_renderings: ['Ramban', 'Nahmanides'] }] },
  { source_id: 'project-abbreviation:rashba', surface: 'הרשב״א', expansion: 'רבי שלמה בן אדרת', renderings: ['Rashba'] },
  { source_id: 'project-abbreviation:ha-shakh', surface: 'הש״ך', expansion: 'שפתי כהן', renderings: ['the Shakh'], breakdown: [{ hebrew: 'ה־', strict_renderings: ['the'] }, { hebrew: 'ש״ך', strict_renderings: ['Shakh'] }] },
  ...
  { source_id: 'project-abbreviation:yesh-lomar', surface: 'י״ל', expansion: 'יש לומר', renderings: ['one can say', 'it can be said'] },
  ...
  { source_id: 'project-abbreviation:de-savira-lei', surface: 'דס״ל', expansion: 'דסבירא ליה', renderings: ['that he holds', 'who holds'], breakdown: [{ hebrew: 'ד־', strict_renderings: ['that', 'who'] }, { hebrew: 'ס״ל', strict_renderings: ['he holds', 'he maintains'] }] },
  ...
  { source_id: 'project-abbreviation:ein-tzarikh', surface: 'א״צ', expansion: 'אין צריך', renderings: ['need not', 'it is not necessary'] },
  { source_id: 'project-abbreviation:nireh-li', surface: 'נ״ל', expansion: 'נראה לי', renderings: ['it seems to me'] },
  { source_id: 'project-abbreviation:hu-hadin', surface: 'ה״ה', expansion: 'הוא הדין', renderings: ['the same law applies'] },
...
const projectMidrashFormulaDefinitions = [
  ...
  {
    source_id: 'project-midrash-formula:pasuk-abbrev',
    surface: '\u05E4\u05E1\u05F3',
    surface_forms: ['\u05E4\u05E1\''],
    expansion: '\u05E4\u05E1\u05D5\u05E7',
    renderings: ['verse', 'scriptural verse'],
    kind: 'Citation abbreviation',
  ...
  },
  {
    ...
    surface: '\u05EA\u05F4\u05DC',
    surface_forms: ['\u05EA"\u05DC'],
    expansion: '\u05EA\u05DC\u05DE\u05D5\u05D3 \u05DC\u05D5\u05DE\u05E8',
    renderings: ['Scripture says', 'the verse teaches'],
    kind: 'Rabbinic citation formula',
    work_scope: midrashAggadahScope,
  },
  {
  ...
  {
    source_id: 'project-midrash-label:lamed-hashem',
    surface: '\u05DC\u05D4\u05F3',
    expansion: '\u05DC\u05D4\u05E9\u05DD',
    renderings: ['to the Lord', 'for the divine Name'],
    kind: 'Divine-name abbreviation',
    breakdown: [
      { hebrew: '\u05DC\u05BE', strict_renderings: ['to', 'for'] },
      { hebrew: '\u05D4\u05F3', strict_renderings: ['the Lord', 'the divine Name'] },
    ],
    work_scope: midrashAggadahScope,
  },
  ...
  {
    source_id: 'project-midrash-label:rabbi-title',
    surface: '\u05E8\u05D1\u05D9',
    renderings: ['Rabbi'],
    kind: 'Rabbinic title',
  ...
  {
    source_id: 'project-midrash-name:shimon',
    surface: '\u05E9\u05DE\u05E2\u05D5\u05DF',
    renderings: ['Shimon', 'Simeon'],
    kind: 'Proper-name label',
    work_scope: midrashAggadahScope,
  },
  {
  ...
  {
    source_id: 'project-midrash-grammar:mikan',
    surface: '\u05DE\u05DB\u05D0\u05DF',
    surface_forms: ['\u05DE\u05D9\u05DB\u05DF'],
    renderings: ['from here'],
    kind: 'Closed-class citation inference formula',
    work_scope: midrashAggadahScope,
  },
  {
    source_id: 'project-midrash-grammar:lehalan',
    surface: '\u05DC\u05D4\u05DC\u05DF',
    renderings: ['below', 'later'],
    kind: 'Closed-class reference adverb',
    work_scope: midrashAggadahScope,
  },
  {
    source_id: 'project-midrash-grammar:kegon',
    surface: '\u05DB\u05D2\u05D5\u05DF',
    renderings: ['such as', 'for example'],
    kind: 'Closed-class example marker',
    work_scope: midrashAggadahScope,
  },
  {
    source_id: 'project-midrash-grammar:minayin',
    surface: '\u05DE\u05E0\u05D9\u05DF',
    renderings: ['from where', 'whence'],
    kind: 'Closed-class proof formula',
    work_scope: midrashAggadahScope,
  },
  {
...
const fixedExpressions = [
  ...
  },
  {
    ...
    source_row: {
      ...
      license_url: 'local:grammar-rules',
      fields_used: ['closed-class Hebrew grammar form lookup', 'strict renderings', 'mechanical breakdown'],
      notes: 'Project-maintained closed-class Hebrew grammar rule. No external dictionary text imported.',
    },
  },
];
...
function isEntryAllowedForWork(entry, workId) {
  ...
  if (entry?.work_scope && !['kabbalah', 'zohar_ari', aramaicScope, midrashAggadahScope, rabbinicTitleScope].includes(entry.work_scope) && entry.work_scope !== workId) return false;
  return true;
}
...
function analyzeAffixSurfaceForm(surfaceWord, normalizedWord, workId) {
  ...
  for (const attempt of attempts) {
    ...
    const trustedProjectBase = ['project_function_word', 'project_abbreviation', 'project_midrash_formula'].includes(matchMethod);
...
const lexiconChanged = fixedExpressionEntriesChanged || abbreviationEntriesChanged || midrashFormulaEntriesChanged || aramaicGrammarEntriesChanged || zoharAriTermEntriesChanged;
...
const testRefs = matchedForms
  .slice(0, 3)
  .flatMap((row) => (row.refs || []).slice(0, 1))
  .filter(Boolean);
