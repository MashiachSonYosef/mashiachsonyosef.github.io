...
const artifact = {
  ...
  counts: {
    ...
    selected_frame_neighbor_matrix_status: handoff.validation?.selected_frame_neighbor_matrix_status ?? null,
    selected_frame_neighbor_frame_rows: handoff.validation?.selected_frame_neighbor_frame_rows ?? null,
    selected_frame_neighbor_cells: handoff.validation?.selected_frame_neighbor_cells ?? null,
    selected_frame_neighbor_observations: handoff.validation?.selected_frame_neighbor_observations ?? null,
    selected_frame_neighbor_shared_buckets: handoff.validation?.selected_frame_neighbor_shared_buckets ?? null,
    selected_frame_neighbor_specific_buckets: handoff.validation?.selected_frame_neighbor_specific_buckets ?? null,
    selected_frame_neighbor_reader_facing_rows: handoff.validation?.selected_frame_neighbor_reader_facing_rows ?? null,
    selected_frame_neighbor_route_payload_field_hits: handoff.validation?.selected_frame_neighbor_route_payload_field_hits ?? null,
...
function buildChecks() {
  ...
  return [
    ...
    check('selected_qa_package_current', Number(handoff.validation?.selected_qa_package_items || 0) >= 25, `selected QA package items ${handoff.validation?.selected_qa_package_items}`),
    ...
    check('frame_neighbor_matrix_complete', handoff.validation?.selected_frame_neighbor_matrix_status === 'present' && Number(handoff.validation?.selected_frame_neighbor_cells || 0) > 0 && Number(handoff.validation?.selected_frame_neighbor_shared_buckets || 0) > 0 && Number(handoff.validation?.selected_frame_neighbor_specific_buckets || 0) > 0 && Number(handoff.validation?.selected_frame_neighbor_reader_facing_rows || 0) === 0 && Number(handoff.validation?.selected_frame_neighbor_route_payload_field_hits || 0) === 0, `frame-neighbor ${handoff.validation?.selected_frame_neighbor_matrix_status}; cells ${handoff.validation?.selected_frame_neighbor_cells}; shared/specific ${handoff.validation?.selected_frame_neighbor_shared_buckets}/${handoff.validation?.selected_frame_neighbor_specific_buckets}; payload hits ${handoff.validation?.selected_frame_neighbor_route_payload_field_hits}`),
...
function writeReport(relativePath, artifact) {
  const lines = [
    ...
    `- Frame neighbor matrix: ${artifact.counts.selected_frame_neighbor_matrix_status}, frames ${artifact.counts.selected_frame_neighbor_frame_rows}, cells ${artifact.counts.selected_frame_neighbor_cells}, observations ${artifact.counts.selected_frame_neighbor_observations}, shared/specific ${artifact.counts.selected_frame_neighbor_shared_buckets}/${artifact.counts.selected_frame_neighbor_specific_buckets}, reader-facing ${artifact.counts.selected_frame_neighbor_reader_facing_rows}, payload hits ${artifact.counts.selected_frame_neighbor_route_payload_field_hits}`,
