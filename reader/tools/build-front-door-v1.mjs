...
const atlasRow = (w) => {
  ...
  if (zi) {
    ...
    return `      <span class="atlas-row built${zi.stamp ? " stamped" : ""}"><span class="pair pair-l"><span class="col-en"><a class="aw" href="/${name}" title="open this book">${label}</a></span><span class="col-att">${att}</span></span><span class="pair pair-r"><span class="col-he">${he}</span><span class="col-lic">${lic}</span></span></span>`;
  }
