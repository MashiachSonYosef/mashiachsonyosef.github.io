...
<main
  ...
  <div class="topbar"><button id="face" class="face" type="button" title="the other face of the page">day</button>${page.altLink}</div>
  <h1>${page.h1}</h1>
