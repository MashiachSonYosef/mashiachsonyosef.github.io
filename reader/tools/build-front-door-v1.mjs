...
const DEF_POSITIONS = [
  ...
  { id: "masoretic", lab: "masoretic", live: false, kind: "order", shown: true,
    from: "the lattice \u00b7 the match grade \u2014 not on this disk",
  ...
  { id: "cites", lab: "cites here", live: false, kind: "order", shown: true,
    from: "the lattice \u00b7 names_this_verse \u2014 not on this disk",
  ...
  { id: "vowels-differ", lab: "vowels differ", live: false, kind: "order", shown: true,
    from: "the lattice \u00b7 VOWEL_MISMATCH \u2014 not on this disk",
    say: "Readings whose source points the word differently while the letters agree \u2014 the masoretic position turned over. Waiting on the same lattice." },
  { id: "outside-era", lab: "outside the era", live: false, kind: "order", shown: true,
    from: "data/source-corpus-v1.json \u00b7 declared_corpus, inverted",
    say: "Lexicons explicitly NOT of the text\u2019s own era first, to let a reader watch the sense move. Nothing this shelf cites is classified that way yet \u2014 unknown is not the same as later, and ranking on unknown would be the claim this project refuses." },
