...
window.FRAME_RECORD_V1 = Object.freeze({
  ...
  "owner_stated_frame_2026_09_01": {
   "stated_on": "2026-09-01",
   "stated_by": "the owner, in conversation, carrying the corpus lane's drafting",
   "quoted": "his wording throughout, with the corpus lane's phrasing where he adopted it",
   "what_this_is": "the frame is a LINE-ITEM INCLUSION CHECKLIST. It answers whether a thing goes in. It is not a code specification and never says that a letter carries a link or a field \u2014 those are technical truths and they live in the tree with a rule id and a gate, not here.",
   "supersedes": "owner_stated_frame_2026_08_31, which is kept above rather than replaced. The sealed_frame is history and does not change.",
   "what_changed_since_2026_08_31": [
    "N now carries the admission law itself: Hebrew and Aramaic only, admission is affirmative, and provenance outranks label.",
    "W says what a COMPcell may be \u2014 part of its own W, or a pointer to a different W attested elsewhere.",
    "COMPspan takes in affixation, maqaf and abbreviation, and settles that an abbreviation is an ordinary COMPspan with two options rather than a special case.",
    "K gains the sentence that makes it safe: it is for finding, never for proving.",
    "V is bound to a C0 rather than a work; work-to-work standing is U's.",
    "Q gains the section label as a kind, and the masorah's midpoint is stated three ways.",
    "O is rewritten entirely. It was the named stream and which copy is broken. It is now WHAT IS NOT HERE and why, with RECEIVED and CHOSEN never conflated."
   ],
   "letters": {
    "A": "a licensable span of Hebrew or Aramaic.",
    "N": "the license for that span. HEBREW AND ARAMAIC ONLY. Admission is affirmative: a source declares its language or it is not admitted. Provenance outranks label.",
    "B": "an attestable grouping, identified by its Hebrew name, and carrying every name the world uses to find it \u2014 \"Book of Kings,\" \"Tikkunei Zohar,\" what a reader types into a search box. The Hebrew name identifies the grouping; the finding-names are a list on it, each attested separately to catalogs and usage. A name typed here because none is attested says so.",
    "C0": "the exact location and unique identifier for the specific occurrence. In plain words: the ink \u2014 the mark itself, at its position.",
    "W": "the compositional holder for the Hebrew word \u2014 \u05d1\u05b0\u05bc\u05e1\u05b4\u05e4\u05b0\u05e8\u05d5\u05b9 as attested. A COMPcell is either a part of its own W, or a pointer to a different W attested elsewhere. An abbreviation's expansion is the second kind.",
    "COMPspan": "the complete set of licensable spans a Hebrew word divides into. For \u05d1\u05b0\u05bc\u05e1\u05b4\u05e4\u05b0\u05e8\u05d5\u05b9 that set is: \u05d1\u05b0\u05bc \u00b7 \u05e1\u05b4\u05e4\u05b0\u05e8 \u00b7 \u05d5\u05b9 \u00b7 \u05d1\u05b0\u05bc+\u05e1\u05b4\u05e4\u05b0\u05e8 \u00b7 \u05e1\u05b4\u05e4\u05b0\u05e8+\u05d5\u05b9 \u00b7 \u05d1\u05b0\u05bc+\u05e1\u05b4\u05e4\u05b0\u05e8+\u05d5\u05b9",
    "COMPcell": "a given COMPspan selectable such as \u05d1\u05b0\u05bc + \u05e1\u05b4\u05e4\u05b0\u05e8, making it premappable as the things we need licenses for and map out for every word before even having a definition, per formulaic Hebrew.",
    "K": "a search key that discards evidence through normalization. A D matched on K alone is weaker than one matched on the pointed surface. K IS FOR FINDING, NEVER FOR PROVING. Not for counting, not for identity, not as evidence that a thing is what it looks like.",
    "D": "the exact licensable definition of a given COMPcell.",
    "R": "the debundler selection gloss layer when a COMPcell comes with several definitions in a single license, to allow any one to hold the full frame.",
    "M": "the license record and the book it came from. Its language must be Hebrew or Aramaic (Chaldee). Struck: any source naming a language outside that set \u2014 Syriac and Mandaic included, though both are Aramaic \u2014 and any source that declares itself non-Hebrew without naming which language it is. A source that cannot say it is not Yiddish is not admitted for not having been asked.",
    "P": "assigns M to R pills.",
    "S": "a pointer for source year that helps sort only.",
    "V": "attaches commentary, counter-commentary, super-commentary and other attachable works to a location \u2014 a C0, not a work. Work-to-work standing is U's.",
    "Y": "for locating \u2014 chapter 22, daf 92a, tikkun 58 \u2014 and the measures of that address space. In plain words: the claim the mark makes.",
    "X": "attestations for B, Y, V, and U. In plain words: who says so.",
    "Z": "dual: the catchword as quoted and where it lands in C0, with a miss counting as variant evidence. \u05d3\u05d9\u05d1\u05d5\u05e8 \u05d4\u05de\u05ea\u05d7\u05d9\u05dc, abbreviated \u05d3\"\u05d4.",
    "Q": "what kind of mark it is: ketiv/qere \u00b7 petuchah \u00b7 setumah \u00b7 inverted nun \u00b7 masorah finalis \u00b7 section label. C0 holds the actual mark; Q holds the kind and the ruling.",
    "U": "work to work relationals: edition-of, translation-of, recension-of.",
    "O": "WHAT IS NOT HERE, and why. The named stream and which copy is broken \u2014 and equally, a work we serve knowingly incomplete. Two causes, both recorded, never conflated. RECEIVED: the copy arrived damaged; a book with no section marks may be a book that arrived flattened, not a book without them, and a work named in the bridge with no stream anywhere is claimed and not held. CHOSEN: we left it out \u2014 out-of-scope language, an unlicensed portion, a part we hold and do not serve. A work served silently short claims to be whole. O is what stops that."
   },
   "notes": {
    "compspan_reaches": "COMPspan can include prefix/suffix (affixation), maqaf, and abbreviation.",
    "abbreviation_is_not_a_special_case": "An abbreviation is a normal COMPspan with two options. Option 1: the abbreviation as written, defined as itself. Option 2: the words it stands for, each defined separately, shown together with +'s between their glosses.",
    "the_lattice_defines_it_does_not_display": "Selecting option 2 does not change the Hebrew on the page. C0 still shows the letters the source wrote. The lattice chooses what gets DEFINED, not what gets DISPLAYED \u2014 the same as ketiv/qere, where C0 shows both branches and selecting one narrows which is defined.",
    "what_needs_attesting_in_an_abbreviation": "The words in option 2 are not new Hebrew. Each is a word attested elsewhere in the corpus and the cell points at it. What needs attesting is the MAPPING \u2014 that these letters stand for those words \u2014 not the words.",
    "compspan_is_for_definition": "COMPspan is for what needs to be defined by English, not what shows as the C0.",
    "the_set_and_its_members": "COMPspan is the entire set. COMPcell is each selectable member of that set. \u05d1\u05b0\u05bc + \u05e1\u05b4\u05e4\u05b0\u05e8 + \u05d5\u05b9 is therefore the maximal COMPcell, not another COMPspan.",
    "two_things_not_one": "W.surface is the attested word exactly as it occurs in the Hebrew text. The maximal COMPcell is the selectable compositional interpretation containing every component. They are not the same object."
   },
   "open": {
    "the_affix_inventory": "The seven prefix letters are external input. Trivial and uncontroversial, but by our own citation rule it cannot enter as though the corpus produced it. It needs a source named, or a note saying it has none.",
    "findability_is_closed": "An abbreviation's cells point at words attested elsewhere in the corpus. The cell references an existing W rather than inventing Hebrew, so nothing is exempted from the findability rule. Only the MAPPING needs a witness."
   },
   "operational_laws": [
    "Carrier flags travel with C0 from the corpus, not the build. Both OFF and NUMERAL. Whoever seals C0 decides what counts \u2014 otherwise sealed and served counts disagree.",
    "A stream's identity cannot be its position count. Seals must cover content bytes. Stream names have been found resolving to different contents with identical row counts, spans, and first_c0 \u2014 every positional check passed.",
    "An assertive mark isn't attested until we've counted it ourselves. HELD_UNCOUNTED is still an assumption and may not be cited."
   ],
   "why_the_masorah_forces_OFF": "The masorah demands that the book splits into halves. If a non-book word \u2014 the masorah itself, a section break, a line break \u2014 is allowed through as ON, the two halves do not come out equal, and I Kings and II Kings are the two halves of the Book of Kings.",
   "the_two_properties_worked_example": {
    "an ordinary word": {
     "counts": "yes",
     "opens_the_catalog": "yes"
    },
    "an abbreviation": {
     "counts": "yes",
     "opens_the_catalog": "yes \u2014 as itself"
    },
    "a numeral": {
     "counts": "yes",
     "opens_the_catalog": "no"
    },
    "the masorah": {
     "counts": "no",
     "opens_the_catalog": "yes"
   ...
   "marks_named": {
    "ketiv": "(\u05dc\u05e2\u05d1\u05d3\u05d9\u05da) \u2014 written",
    "qere": "[\u05dc\u05b0\u05e2\u05b7\u05d1\u05d3\u05b8\u05d6\u05da\u05b0] \u2014 read",
    "setumah": "\u05e1\u05b0\u05ea\u05d5\u05bc\u05de\u05b8\u05d4, abbreviated {\u05e1} \u2014 closed",
    "petuchah": "\u05e4\u05b0\u05bc\u05ea\u05d5\u05bc\u05d7\u05b8\u05d4, abbreviated {\u05e4} \u2014 open",
    "nun_hafukhah": "\u05e0\u05d5\u05bc\u05df \u05d4\u05b2\u05e4\u05d5\u05bc\u05db\u05b8\u05d4 \u2014 inverted nun",
    "masorah_finalis": "\u05de\u05e1\u05d5\u05e8\u05d4 \u05e1\u05d5\u05e4\u05d9\u05ea \u2014 the scribes' bookkeeping at the end of a book"
  ...
  "q_rules_2026_09_01": {
   "stated_on": "2026-09-01",
   "statement": "Q points. C0 holds. These are the rules Q carries per kind.",
   "supersedes": "q_rules_2026_08_31, kept above rather than replaced.",
   "shared": [
    "Q never holds text. Every mark, branch or note Q names must be findable inside the carrier, in order. If it isn't, the build refuses rather than retyping the text.",
    "Every Q site carries two properties, and they are independent questions. Recording one does not answer the other. counts_as_book_word (ON | OFF) asks whether it counts when the book is measured; lexical_key (key | none) asks whether its surface opens the catalog. An ordinary word counts and opens. A numeral \u2014 \u05e7 naming 100 \u2014 counts and does not open. The masorah \u2014 \u05d7\u05e6\u05d9 \u05d4\u05e1\u05e4\u05e8 \u2014 does not count and does open. {\u05e4} {\u05e1} \u05c6 and a section label neither count nor open.",
    "OFF MEANS DOES NOT COUNT. It does not mean \"carries no key.\" Nothing may be typed OFF for being unkeyable, and nothing denied a key for being OFF.",
    "A numeral is a word of the book: written, read, counted. It does not open the catalog because \u05e7 naming a hundred is not an occurrence of qof \u2014 the precedent already in build-zone: a token the ledger marks as a NUMBER carries no lexical key, it reuses a letter's identity to name a number and is not an occurrence of that letter, so the catalog is not asked about it.",
    "The masorah is its mirror: real Hebrew words meaning what they say, which are not words of the book. \u05d7\u05e6\u05d9 means half, and defining it as half is correct. It simply is not part of what the book says.",
    "THE COUNT IS OVER POSITIONS, NEVER OVER ROWS. A written/read site is two rows at one word position: both ON, both read, both keyed, and we refuse to choose between them \u2014 but the position counts once. Same shape as the B law, where the census counts realizations and never members. Counting rows inflates every book carrying a pair.",
    "A reading attaches to a word. A mark attaches to a position. Nothing welds. Any token whose surface is a mark concatenated with Hebrew is refused. These are live \u2014 \u05e1\u05d5\u05d9\u05d0\u05de\u05e8, \u05e1\u05d6\u05d0\u05ea, \u05e1\u05d1\u05e0\u05d9\u05d4 \u2014 a mark fused to the next word because the tokenizer split on spaces and the separator was an HTML entity, not a space.",
    "Absence is not evidence, and encoding is not absence. A book with no Q sites may be a book that arrived flattened \u2014 or a book whose marks are written in a form nobody counted. Eight books appeared to have no section marks at all until the bare (\u05e1) form was counted beside the tagged one; they had them the whole time. The end-of-book masorah, by contrast, is genuinely missing from every Tanakh stream we hold. A book known flattened must not present as complete, and a book must not be called flattened before every encoding of its marks has been counted.",
    "An implicit maqaf is not a Q. A maqaf joins words, so it belongs to W and the COMPspan lattice, not to a pointer at a mark.",
    "OFF travels with C0 from the corpus, not from the build. A zone checks its word count against a sealed figure, so a mark excluded only at build time fails the arithmetic. Carrier flags into C0 and the seals recut to the ON-POSITION count come first; masorah acquisition second. Reversed, the verification's first act is to accuse the scribes of miscounting with numbers we broke ourselves.",
    "NO COUNTS LIVE IN THIS DOCUMENT. Every figure here went stale within a day of being written. The frame states the rule; the ledger holds the number, where it can be re-derived and corrected."
   ],
   "kinds": {
    "kq": {
     "title": "written / read",
     ...
     "lexical_key": "both branches are words of the book and both open the catalog: one key per branch, taken from inside the delimiters, delimiters stripped. Two keys at one C0. This is the only Q kind that is ON.",
     "the_card_answers_for": "both readings. The lattice sits inside the card; selecting a half underlines that half in the line and shows that half's English only. One English at a time.",
     "multi_word_branches": "a branch may be more than one word \u2014 psalms-123-4 writes (\u05dc\u05d2\u05d0\u05d9\u05d5\u05e0\u05d9\u05dd) and reads [\u05dc\u05d2\u05d0\u05d9 \u05d9\u05d5\u05e0\u05d9\u05dd]. The branch carries its words as separate keys in order. Never one welded key.",
     "the_gate_refuses": [
      "a branch that opens a delimiter and never closes it",
    ...
    "petuchah": {
     ...
     "what_the_source_wrote": "{\u05e4}, class mam-spi-pe. An abbreviation for \u05e4\u05b0\u05bc\u05ea\u05d5\u05bc\u05d7\u05b8\u05d4.",
     "c0": "a position, standing after the last word of the section that closes. Not a word, not part of one.",
     "why_unkeyed": "the surface is not the word it means: \u05e4 here abbreviates petuchah and is not an occurrence of the letter pe. Bare \u05e1/\u05e4 keys currently route to dictionary entries for the letters. All of them come out.",
     "how_it_is_recognised": "by the source's own class OR by its bare glyph shape \u2014 (\u05e4) {\u05e4} [\u05e4] or a bare \u05e4 carrying no points. Never by the normalized key, which sweeps in ordinary pointed words, and never by the class alone, which misses the bare form entirely. In eight books the bare form is the only form.",
     "the_card_answers_for": "the word \u2014 petuchah, \"open\" \u2014 and what it does: this section ends here, and the next begins on a fresh line.",
     "the_display_obligation": "if the renderer can't give the break its line, the card says so in plain English at the top. A petuchah drawn as nothing is a flattening.",
     "the_gate_refuses": [
      "a bare \u05e4 carrying a lexical key",
      "a mark welded to an adjacent word",
      "a mark given a word's C0 instead of its own position",
    ...
    "setumah": {
     ...
     "key": "unkeyed",
     "what_the_source_wrote": "{\u05e1}, class mam-spi-samekh. An abbreviation for \u05e1\u05b0\u05ea\u05d5\u05bc\u05de\u05b8\u05d4.",
     "everything_under_petuchah_holds": "with two differences.",
     "the_card_answers_for": "the word \u2014 setumah, \"closed\" \u2014 and what it does: this section ends, and the next begins on the same line, after a gap.",
     "the_display_obligation": "a different one. Petuchah means a new line. Setumah means a visible gap without one. A renderer that draws both the same has erased a distinction the source made, and must say which one it can't honor."
    },
    "invnun": {
     "title": "inverted nun",
     "counts": "OFF",
     ...
     "what_the_source_wrote": "\u05c6 \u2014 U+05C6 HEBREW PUNCTUATION NUN HAFUKHA, class mam-spi-invnun. The name is \u05e0\u05d5\u05bc\u05df \u05d4\u05b2\u05e4\u05d5\u05bc\u05db\u05b8\u05d4.",
     "c0": "a position. It marks a passage, not a word.",
     "why_unkeyed": "the clearest case of them all: \u05c6 is a punctuation character, not the letter nun. It never carries a key.",
     "the_card_answers_for": "the mark's name, and what the tradition says with it \u2014 this passage is marked as standing apart.",
     "pairing": "the source's business, not a requirement. In Psalm 107 the marks stand singly. In Numbers 10:35-36 two of them bracket the passage. So Q records whether a mark opens, closes, or stands alone \u2014 it does not demand a partner.",
     "the_gate_refuses": [
      "a key for the letter nun",
    ...
    "section_label": {
     "title": "a single letter or numeral labeling a division",
     "counts": "OFF",
     "key": "unkeyed",
     "what_the_source_wrote": "a bare letter at a section head \u2014 \u05d1 at the start of a division. Same cell as {\u05e1}: it labels the division, it is not a word of it."
    },
    "masorah": {
     "title": "the book's own count",
     "counts": "OFF",
     "key": "keyed",
     "what_the_source_wrote": "the masorah finalis (\u05de\u05e1\u05d5\u05e8\u05d4 \u05e1\u05d5\u05e4\u05d9\u05ea), the scribes' bookkeeping at the end of a book: \u05e1\u05db\u05d5\u05dd \u05e4\u05e1\u05d5\u05e7\u05d9 \u05d4\u05e1\u05e4\u05e8, the verse total \u00b7 \u05d7\u05e6\u05d9 \u05d4\u05e1\u05e4\u05e8 \u05d1\u05e4\u05e1\u05d5\u05e7\u05d9\u05dd, the midpoint by verses \u00b7 \u05d7\u05e6\u05d9 \u05d4\u05e1\u05e4\u05e8 \u05d1\u05ea\u05d9\u05d1\u05d5\u05ea, by words \u00b7 \u05d7\u05e6\u05d9 \u05d4\u05e1\u05e4\u05e8 \u05d1\u05d0\u05d5\u05ea\u05d9\u05d5\u05ea, by letters \u00b7 \u05e1\u05d9\u05de\u05df, a gematria mnemonic for the count \u00b7 \u05d5\u05e4\u05e8\u05e9\u05d9\u05d5\u05ea\u05d9\u05d5 and \u05d5\u05e1\u05d3\u05e8\u05d9\u05d5, the parashah and seder counts, which tie to U.",
     "the_midpoint_is_given_three_ways": "by verses, by words, by letters \u2014 because they land in different places.",
     "the_only_checkable_claim": "it is the only mark that makes a CHECKABLE CLAIM, so recording it is not attesting it. The half must be counted.",
     "the_mark_and_its_claim_are_two_objects": "C0 holds the ink \u2014 positions after the last verse, the scribe's own hand, inside the book, flagged OFF. Genesis's section marks hold real C0 ids inside real units; a chapter number has no C0 id and could never have one, and that is what makes this C0 and not Y. Q holds the kind, and which measure it states. Y holds the claim: \"N verses, the middle here\" is a structural assertion about the book's division, which is Y's shape exactly. X holds who says so.",
     "the_verification": "Y against Y: our counted division against the scribe's asserted division. Two structural claims about one book, settled by arithmetic, in a letter that already exists.",
     "why_OFF": "these are not words of the book and are excluded from every count the book reports \u2014 verses, words, letters. Load-bearing, not tidiness: a masorah counted among the book's words inflates the total, which then disagrees with the masorah's own figure, and the check files CONTRADICTED against a number that was right for a fault that was ours.",
     "why_keyed": "the only OFF kind that is. These are ordinary Hebrew words meaning what they say. \u05d7\u05e6\u05d9 opens to \"half\" like any other word. The phrase means the midpoint of the book; the words mean what they mean; the reader is shown both, and neither is forced to stand for the other.",
     "the_card_answers_for": "that it is not a word of the book, and what the scribes recorded here \u2014 then the ordinary card beneath it, same lattice, same routes, same licenses. The banner stands above an ordinary card, never instead of one.",
     "recording_is_not_attesting": "a count written down is an assertion until someone counts. Every masorah claim carries one of: NOT_HELD, we do not have the claim \u00b7 HELD_UNCOUNTED, we have it and have not verified it, still an assumption \u00b7 VERIFIED, we counted from C0 and it agrees \u00b7 CONTRADICTED, we counted from C0 and it does not.",
     "a_disagreement_is_a_finding": "HELD_UNCOUNTED may not be cited anywhere a reader can see. A disagreement is published as a finding: neither side is corrected toward the other, and the two counts stand together with their editions named.",
     "the_gate_refuses": [
      "a masorah site counted among the book's words",
      "a claim cited while HELD_UNCOUNTED",
      "a count silently corrected toward the masorah, or the masorah toward it",
