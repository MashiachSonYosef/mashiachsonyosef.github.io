...
Generated: 2026-06-01T08:21:49.263Z
...
- Source freshness: stale, count delta 95, modified after artifact 100
...
- Usage refresh priority: present, pending 100, known-use candidates 0, review-only 100, promoted 0, blocked broad refresh files 100, route payload hits 0
...
- Usage selected source diversity: present, rows 49, source refs 38, work anchors 38, works 20, categories 1, licenses 2, version sources 4, duplicate source-ref buckets 8, duplicate source-ref rows 19, missing signature rows 0, reader-facing rows 0, route payload hits 0
- Usage selected provenance matrix: present, buckets 5, rows 49, licenses 2, version sources 4, license metadata rows 49, version metadata rows 49, missing or unrecognized license rows 0, samples 49, reader-facing rows 0, route payload hits 0
- Usage selected collision audit: present, buckets 16, occurrence rows 38, duplicate source-ref buckets 8, duplicate work-anchor buckets 8, cross-frame buckets 4, cross-frame rows 14, reader-facing rows 0, route payload hits 0
- Usage selected collision/provenance audit: present, buckets 16, occurrence rows 38, provenance buckets 4, frame/provenance buckets 7, missing provenance rows 0, missing frame/provenance rows 0, samples 38, reader-facing rows 0, route payload hits 0
...
- Usage selected frame bridge index: present, rows 4, edge memberships 2352, same-frame rows 2, bridge rows 2, same-frame edges 1192, bridge edges 1160, route IDs 1, provenance buckets 5, sample rows 32, reader-facing rows 0, route payload hits 0
- Usage selected frame bridge samples: with links 32, with context 32
...
- Usage selected QA package: present, items 21, rows 49, route IDs 1, unresolved routes 0, route warning visible 1, directed edges 2352, bridge edges 1160, reader-facing rows 0, route payload hits 0
...
| report_source_freshness | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/source-freshness.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/source-freshness.md / Source freshness stale; current 1287; scanned 1192; modified after artifact 100; created after artifact 95 |
| validate_source_freshness | passed | Validated workbench source freshness .local-cache/workbench-evidence/smoke-pipeline-validation/source-freshness.json: status stale; pending 100 |
...
| build_usage_refresh_priority_index | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-refresh-priority-index.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-refresh-priority-index.md / Usage refresh priority pending 100; known-use candidates 0; promoted 0 |
| validate_usage_refresh_priority_index | passed | Validated usage refresh priority index .local-cache/workbench-evidence/smoke-pipeline-validation/usage-refresh-priority-index.json: pending 100; promoted 0 |
...
| build_usage_selected_source_diversity | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-source-diversity.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-source-diversity.md / Selected source diversity rows 49; source refs 38; works 20 |
| validate_usage_selected_source_diversity | passed | Validated usage selected source diversity .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-source-diversity.json: rows 49; source refs 38; works 20 |
...
| build_usage_concentration_packet | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-concentration-packet.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-concentration-packet.md / Usage concentration status pass_with_warnings; warnings 1; failed 0 |
| validate_usage_concentration_packet | passed | Validated usage concentration packet .local-cache/workbench-evidence/smoke-pipeline-validation/usage-concentration-packet.json: status pass_with_warnings; warnings 1 |
| build_usage_selected_route_concentration_response | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-route-concentration-response.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-route-concentration-response.md / Selected route concentration response rows 49; route warning 1; source refs 38 |
| validate_usage_selected_route_concentration_response | passed | Validated usage selected route concentration response .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-route-concentration-response.json: rows 49; route warning visible |
| build_usage_selected_occurrence_cards | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-occurrence-cards.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-occurrence-cards.md / Selected occurrence cards 49; context 49; related signatures 21 |
...
| build_usage_selected_provenance_matrix | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-provenance-matrix.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-provenance-matrix.md / Selected provenance buckets 5; rows 49; licenses 2; missing/unrecognized license rows 0 |
| validate_usage_selected_provenance_matrix | passed | Validated usage selected provenance matrix .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-provenance-matrix.json: buckets 5; selected rows 49 |
| build_usage_selected_collision_audit | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-collision-audit.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-collision-audit.md / Selected collision audit buckets 16; collision rows 38; cross-frame buckets 4 |
| validate_usage_selected_collision_audit | passed | Validated usage selected collision audit .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-collision-audit.json: buckets 16; cross-frame buckets 4 |
...
| build_usage_selected_frame_provenance_matrix | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-frame-provenance-matrix.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-frame-provenance-matrix.md / Selected frame/provenance matrix rows 10; selected rows 49; provenance buckets 5 |
| validate_usage_selected_frame_provenance_matrix | passed | Validated usage selected frame/provenance matrix .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-frame-provenance-matrix.json: rows 10; selected rows 49 |
| build_usage_selected_collision_provenance_audit | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-collision-provenance-audit.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-collision-provenance-audit.md / Selected collision/provenance audit buckets 16; rows 38; provenance buckets 4 |
| validate_usage_selected_collision_provenance_audit | passed | Validated usage selected collision/provenance audit .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-collision-provenance-audit.json: buckets 16; provenance buckets 4 |
| build_usage_selected_work_frame_matrix | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-work-frame-matrix.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-work-frame-matrix.md / Selected work/frame matrix rows 25; works 20; frames 2; route payload hits 0 |
| validate_usage_selected_work_frame_matrix | passed | Validated usage selected work/frame matrix .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-work-frame-matrix.json: matrix rows 25; selected rows 49 |
...
| build_usage_selected_occurrence_navigation_index | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-occurrence-navigation-index.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-occurrence-navigation-index.md / Selected occurrence navigation rows 49; source refs 38; collision-member rows 19 |
...
| build_usage_selected_frame_bridge_index | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-frame-bridge-index.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-frame-bridge-index.md / Selected frame bridge rows 4; edge memberships 2352; route payload hits 0 |
| validate_usage_selected_frame_bridge_index | passed | Validated selected frame bridge index .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-frame-bridge-index.json: rows 4; edge memberships 2352 |
...
| build_usage_selected_qa_package | passed | Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-qa-package.json / Wrote .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-qa-package.md / Selected QA package items 21; selected rows 49; route payload hits 0 |
| validate_usage_selected_qa_package | passed | Validated usage selected QA package .local-cache/workbench-evidence/smoke-pipeline-validation/usage-selected-qa-package.json: items 21; selected rows 49 |
