...
- Current matrix: `405` inputs, `73` release-relevant rows, `0` handoff candidates.
- Current Agent 3 / Spark-3 rows: `41` / `7`
- Counts match live refresh snapshot: `false`
- Matrix/release/handoff deltas since refresh: `142` / `-43` / `-45`
...
- `reports/spark10-release-package-intake-matrix-current-2026-06-04.json` (321390 bytes, sha256 `4081b221cc6d325cf8eb0454c0aadea28d972ace211d2c05e6be7e6fd5aaf690`)
...
- `data/control/spark_standing_queue.json` (32432 bytes, sha256 `b4e2a880df2e4b7ba64bdf9a6744cd87061870e9e68083672f60aa7ffa0988a6`)
- `data/control/agent_goal_board.json` (372034 bytes, sha256 `5438fcb785b68d1e6ad966504dcab487cd48da9b46689188511c9fff9bb6fb56`)
- `reports/agent3-state.json` (138878 bytes, sha256 `f59d5aaa9c738d4f26a650cb55d250332eafd41a4e39fae5278554ec56f882f0`)
