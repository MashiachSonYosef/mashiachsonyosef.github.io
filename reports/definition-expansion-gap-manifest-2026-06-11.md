...
- Works with coverage: 1353
- Distinct unresolved normalized rows scanned: 24891
- Manifest rows written: 5000
- Rows with any HUD route: 3450
- Rows without route: 1550
- Rows with answer-route candidate needing gate: 95
- Rows preHUD allowed: 0
- NC/Klein/NonCommercial evidence reports found: 50
...
- unknown: 138090 occurrences / 2220 forms
...
- priority 1: aramaic_targum_dictionary | source_needed_license_unverified | missing_commercial_clean_aramaic_dictionary_source
- priority 2: kabbalah_abbreviation_and_technical_terms | project_authored_or_source_needed | abbreviation_or_technical_term_expansion_needed
- priority 3: rabbinic_halakhah_abbreviations | project_authored_or_source_needed | rabbinic_abbreviation_expansion_needed
- priority 99: nc_klein_old_dictionary | noncommercial_evidence_only | nc_noncommercial_not_public_prehud_or_export_authority

## Top Gap Rows

- כתב | 130804 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- ה׳ | 108609 occ | chasidut+kabbalah+musar+unknown | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- דפ | 94379 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- רבינו | 91851 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
...
- שכתב | 51785 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- נמי | 51534 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- ועיינ | 49211 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- לאו | 41958 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
...
- וז״ש | 21519 occ | chasidut+kabbalah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
...
- בגמרא | 18685 occ | chasidut+halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- דמי | 18113 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- בחינת | 18071 occ | chasidut+kabbalah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- דגמ | 17492 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- ראיה | 17132 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- דאפ | 17098 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
...
- י״ל | 14820 occ | chasidut+halakhah+midrash | no_route | project_authored_rabbinic_abbreviation_table | abbreviation_expansion_needed_with_source_license_row
- ו׳ | 14209 occ | chasidut+halakhah+kabbalah+musar+unknown | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- בשבת | 13914 occ | chasidut+halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- כ״א | 13823 occ | chasidut+halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- שאמרו | 13814 occ | chasidut+musar+unknown | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- מאי | 13331 occ | chasidut+kabbalah+midrash+musar | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- דס״ל | 13187 occ | halakhah | no_route | project_authored_rabbinic_abbreviation_table | abbreviation_expansion_needed_with_source_license_row
- דרבננ | 13062 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
- שטר | 12805 occ | halakhah | hud_evidence_only_or_source_review | review_existing_hud_route_before_dictionary_import | hud_evidence_or_source_review_only
