...
Generated: 2026-06-03T06:07:30-04:00
...
- Selection: five tracked render-authority drift pages, about 0.62 MiB, 1.77 MiB, 1.20 MiB, 2.76 MiB, and 3.11 MiB after render. Larger tracked pages and untracked `other` pages remained untouched.

## Checks Run

- `node scripts\validate_route_hud_page.mjs --page halakhah\har-hamoriyah-on-mishneh-torah-offerings-for-those-with-incomplete-atonement\index.html --page halakhah\har-hamoriyah-on-mishneh-torah-offerings-for-unintentional-transgressions\index.html --page halakhah\har-hamoriyah-on-mishneh-torah-paschal-offering\index.html --page halakhah\har-hamoriyah-on-mishneh-torah-sacrifices-rendered-unfit\index.html --page halakhah\har-hamoriyah-on-mishneh-torah-sacrificial-procedure\index.html`
...
- Rollout watch passed with 1,360 generated/current HUD pages, 0 missing pages, 0 source-newer-than-page rows, 0 stale marker rows, and 1 warning that 1,066 generated pages remain older than `scripts\render_site.ps1`.
...
- Current branch relation checked directly: `origin/main...HEAD = 65	130`.
- Latest local commit checked directly: `ffe7479ff (HEAD -> main) Add Orot reader hint Agent 6 docket`.
- Current dirty-path breakdown checked directly: `1407` modified and `1309` untracked.
...
- `reports/agent10-assistant-support-checkpoint-2026-06-03-0607.md`
