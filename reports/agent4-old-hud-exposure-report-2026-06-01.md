...
Generated: 2026-06-01T16:12:25.657Z
...
- Generated pages importing `assets/js/reader-workbench.js`: 1243
...
- HUD accessibility static audit: fail (exit 1)
...
- representative route HUD pages: fail (exit 1)
...
- `hud-preview/routes/index.html`: prototype/reference page carries legacy/prototype source-row or data-hud markers; not a current public HUD page; markers=source-row
...
- `hud-preview/routes/index.html`: HUD prototype/reference artifact; not current public HUD acceptance; markers=source-row
- `hud-preview/routes/app.js`: HUD prototype/reference artifact; not current public HUD acceptance; markers=source-row

## Issues

- 5 validator command(s) failed

## Warnings

- 1 hud-preview prototype/reference page(s) carry legacy/prototype markers and must remain quarantined
- 3 reference/tooling artifact(s) mention old-HUD or prototype markers but are not public runtime imports
