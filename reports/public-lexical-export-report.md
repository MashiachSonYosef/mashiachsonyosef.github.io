...
| --- | ---: | --- |
| data/public-lexical/sitewide/claim-index.jsonl | 9095 | Deduplicated claim-shaped lexical rows across all imported works |
| data/public-lexical/sitewide/normalized-lookup.json | 19234 | Normalized Hebrew form to claim ID lookup |
| data/public-lexical/sitewide/work-summary.jsonl | 181 | Per-work compact-export coverage summary |
...
| Item | Count |
| --- | ---: |
| manifests scanned | 181 |
| chunks scanned | 1355 |
| candidate rows without renderings | 286958 |
