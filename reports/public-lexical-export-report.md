...
| --- | ---: | --- |
| data/public-lexical/sitewide/claim-index.jsonl | 9110 | Deduplicated claim-shaped lexical rows across all imported works |
| data/public-lexical/sitewide/claim-index.csv | 9110 | CSV mirror of the compact claim index |
| data/public-lexical/sitewide/normalized-lookup.json | 19234 | Normalized Hebrew form to claim ID lookup |
| data/public-lexical/sitewide/work-summary.jsonl | 316 | Per-work compact-export coverage summary |
| data/public-lexical/sitewide/work-summary.csv | 316 | CSV mirror of per-work compact-export coverage summary |
...
| Item | Count |
| --- | ---: |
| manifests scanned | 316 |
| chunks scanned | 1685 |
| candidate rows without renderings | 360115 |
