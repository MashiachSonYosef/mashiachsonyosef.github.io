...
- exact_blocker: none
- readiness: wait for a new exact Spark-4 queue item with explicit pipeline_commands and exact input/output schema in data/control/spark_standing_queue.json
