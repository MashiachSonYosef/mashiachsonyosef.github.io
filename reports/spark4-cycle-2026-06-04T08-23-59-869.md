...
- exact_blocker: none
- wake_condition: wait for a new exact Spark-4 queue item in data/control/spark_standing_queue.json with explicit pipeline_commands and input/output schema
- cycle_result: no runnable Spark-4 queue item this cycle
