...
- exact_blocker: none
- readiness: wake on exact Spark-4 queue item with explicit pipeline_commands + input/output schema
- command_execution: no runnable Spark-4 item surfaced this cycle
